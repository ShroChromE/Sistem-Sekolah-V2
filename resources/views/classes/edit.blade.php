...
<div class="mb-8 border-b border-[#E5E3DB] pb-5">
    ...
    <p class="mt-1 text-sm text-slate-500">Memperbarui catatan untuk <span
...
<form action="{{ route('classes.update', $class['id']) }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
    ...
    <div>
        <label for="teacher_id" class="mb-1.5 block text-xs font-semibold uppercase tracking-[0.1em] text-[#16213A]">Wali
            Kelas</label>
