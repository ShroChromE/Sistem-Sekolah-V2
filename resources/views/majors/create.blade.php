...
<form action="{{ route('majors.store') }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
    ...
    <div>
        ...
        <input type="text" id="code" name="code" placeholder="Contoh: AKL" value="{{ old('code') }}"
    ...
    <div>
        ...
        <input type="text" id="name" name="name" placeholder="Contoh: Akuntansi dan Keuangan Lembaga" value="{{ old('name') }}"
            class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
    </div>
    ...
    <div>
        ...
        <textarea id="description" name="description" rows="4" placeholder="Deskripsi singkat jurusan"
