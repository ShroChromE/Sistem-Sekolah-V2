...
<div class="mb-8 border-b border-[#E5E3DB] pb-5">
    <a href="{{ route('teachers.index') }}" class="text-xs uppercase tracking-[0.15em] text-slate-400 hover:text-[#A16207]">&larr; Daftar
        Guru</a>
...
<form action="{{ route('teachers.store') }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
    ...
    <div>
        ...
        <input type="text" id="nip" name="nip" placeholder="Contoh: 198501012024" value="{{ old('nip') }}"
    ...
    <div>
        ...
        <input type="text" id="name" name="name" placeholder="Nama lengkap guru" value="{{ old('name') }}"
            class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
    </div>
    ...
    <div>
        ...
        <input type="text" id="subject" name="subject" placeholder="Contoh: Akuntansi Dasar" value="{{ old('subject') }}"
            class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
    </div>
    ...
    <div>
        ...
        <input type="text" id="phone_number" name="phone_number" placeholder="Contoh: 08123456789" value="{{ old('phone_number') }}"
            class="w-full border border-[#D9D6CD] bg-[#FCFBF8] px-3.5 py-2.5 text-sm placeholder:text-slate-400 focus:border-[#A16207] focus:bg-white focus:outline-none">
    </div>
